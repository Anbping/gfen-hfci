...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--save_valdataroot_name', default='MOT15_val', help='save val result dataroot')
    ...
    self.parser.add_argument('--data_cfg', type=str,
                             default='../src/lib/cfg/mot20.json',
                             help='load data from cfg')
    self.parser.add_argument('--data_dir', type=str, default='/home/hello/jupyter/anbping/gfen-hfci/dataset')
